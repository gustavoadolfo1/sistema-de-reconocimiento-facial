...
root.title("Sistema Control de Asistencia")
...
label = Label(root, text="Sistema Control de Asistencia", font=my_font, foreground="#283142").pack()
...
canvas.pack()
photo = PhotoImage(file=os.getcwd() + '/gui/gecap.png')
photo1 = PhotoImage(file=os.getcwd() + '/gui/add.png')
photo2 = PhotoImage(file=os.getcwd() + '/gui/start.png')
photo3 = PhotoImage(file=os.getcwd() + '/gui/stop.png')
photo4 = PhotoImage(file=os.getcwd() + '/gui/file.png')
photo5 = PhotoImage(file=os.getcwd() + '/gui/exit.png')
photo6 = PhotoImage(file=os.getcwd() + '/gui/clock.png')
photo7 = PhotoImage(file=os.getcwd() + '/gui/cam.png')
photo8 = PhotoImage(file=os.getcwd() + '/gui/upload.png')
...
k = StringVar()
check_bt = Checkbutton(rightframe, text="Set Camera", variable=k, offvalue="cameraoff", onvalue="cameraon",
